...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $article = Article::create([
            ...
            'body'          => 'Ce Samedi 30 septembre, devant Benjamin Franklin, un corps sans vie est retrouvé à l\'angle de la rue Roger Couteau-Lent. D\'abord pris pour une énième flaque de vomi par les passants, c\'est Claudette, 86 ans, qui contacte les secours à 14h du matin. Reportage.
...
"On a tout de suite senti qu\'il y avait un problème", déclare un certain George Profond. "Il ne tenait sa corde que d\'une main, cette dernière enroulée dedans, tandis que l\'autre main tenait sa caméra, sûrement pour montrer à ses amis son exploit." AdminsSeeder.php
...
Pour éviter de futurs accidents, les étudiants sont donc invités à appuyer sur "OK" pour valider leur choix lors des prochains shotguns.',
        ...
        $article = Article::create([
            ...
            'body'          => 'La table était mise. Une table pour trois. Dans la cuisine, le four préchauffait depuis quelques minutes déjà.
...
La cocotte-minute chanta. Elle reposa sa cuillère. Elle venait de terminer la préparation du banana-split. Il était saupoudré de baisers et fait avec amour.
...
Le minuteur retentit sur les douze coups de minuit. Iel venait d’arriver.',
        ...
        $article = Article::create([
            ...
            'body'          => 'Je vous ai suivis. Un par un. Comme une agente du Killer, je me suis glissée dans votre intimité jusque dans votre cuisine pour comprendre ce comportement abject et malsain que vous entretenez tous et toutes.

![](https://userscontent2.emaze.com/images/7aed0141-1bab-46ef-bec6-20d275ae4482/c22acc7660515aba8a3d937cdddcf993.png)
...
Pauvres fous. Heureusement que Cac-carotte m’a redonné le moral en milieu de semaine, sinon je crois bien que cette page serait restée vierge. Mais enfin ! Etudiant rime avec manger équilibré ! Bon ok ça ne fonctionne pas…
...
RENDEZ-MOI MON SCRIPT ! Alors non, mangez normalement, à horaire fixe, ni trop ni pas assez. Allez renflouer les caisses de Cac-carotte et bouffez de la verdure (j’ai bien dit bouffez). Et sortez faire du sport. Oui on a du boulot, oui il fait froid dehors. Mais raison de plus pour faire du sport : ça réchauffe !',
        ...
        $article = Article::create([
            ...
            'body'          => 'Un kilo de patates pour à peu près un euro, pareil pour des carottes pleines de terre, soixante centimes pour deux grosses poignées de champignons. C’est ça le marché ! À la fraîche, un sac à la main le samedi matin.
...
Nous conclurons sur cette métaphore certes osée mais qui nous semble juste. L’Islande est à l’image de son fameux hakarl, elle se complaît dans son urine.',
        ...
        $article = Article::create([
            ...
            'body'          => '> Bonjour, je m\'appelle 保尔, Bao Er. Du moins c’est le nom que l’entreprise de mon père m’a donné lorsqu’il a fallu faire mon visa pour la Chine. Ils ont juste traduit phonétiquement mon nom en caractères chinois. Ça ne veut pas dire grand chose, mais pendant 18 ans on m’a appelé ainsi, du coup c’est devenu mon nom. **Extrait du 1er épisode, Fil P15** 
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Chinese_meal.jpg/1200px-Chinese_meal.jpg)
